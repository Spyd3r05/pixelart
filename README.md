# PIXEL ART MAKER
A browser-based pixel art editor using HTML Canvas, 2D arrays, and vanilla JavaScript. Draw, erase, flood fill, and export your pixel art as PNG.
It's a simpler version of Aseprite. >_<
...
```
  git clone https://github.com/Spyd3r05/pixelart.git
```
...
## Ideas to Keep Building (i'll add this later on)
  ...
  - Make ctrl + s the download shortcut instead of manually clicking the button
...
https://github.com/user-attachments/assets/042d69dd-581d-421d-bdb4-8c4f81f8ea98
